...
CREATE TABLE IF NOT EXISTS genero_libro (
    ...
    CONSTRAINT fk_genero_libro_fk FOREIGN KEY (ISBN) REFERENCES libros(ISBN),
    CONSTRAINT fk_genero_fk FOREIGN KEY (id_genero) REFERENCES genero(id_genero)
);
...
CREATE TABLE IF NOT EXISTS miembro_libro (
    ...
    CONSTRAINT fk_miembro_libro_fk FOREIGN KEY (ISBN) REFERENCES libros(ISBN)
);
...
CREATE TABLE IF NOT EXISTS libro_transaccion (
    ...
    CONSTRAINT fk_libro_miembro_fk FOREIGN KEY (id_miembros) REFERENCES miembros(id_miembros),
    CONSTRAINT fk_transaccion_libro_fk FOREIGN KEY (ISBN) REFERENCES libros(ISBN)
);
...
CREATE TABLE IF NOT EXISTS publicaciones (
    ...
    CONSTRAINT fk_editor_fk FOREIGN KEY (id_editor) REFERENCES editor(id_editor)
);
...
CREATE TABLE IF NOT EXISTS edicion (
    ...
    CONSTRAINT fk_edicion_fk FOREIGN KEY (id_editor) REFERENCES editor(id_editor)
);
